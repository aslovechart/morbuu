...
class Review_articleController extends Controller
{
    ...
    public function actionIndex() {
        ...
        $category = Category::model()->findAll(array('condition' => 'category_id = 3', 'order' => 'name asc'));
        $categoryArr = CHtml::listData($category, 'id', 'id');
        $model->setAttribute('category_id', $categoryArr);
        $this->render('admin', array(
            'model' => $model,
            'option_category'=>CHtml::listData($category, 'name', 'name')
        ));
    }
