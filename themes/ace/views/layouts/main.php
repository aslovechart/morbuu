                            ...
                            'items' => array(
                                    ...
                                    array('label' => '<i class="icon-edit"></i> Articles <b class="arrow icon-angle-down"></b>', 'url' => '#',
                                            ...
                                            'items' => array(
                                                    ...
                                                    array('label' => 'Mobile & IT', 'url' => array('/article/mobile/'), 'active' => $controller_name == 'mobile'),
                                                    array('label' => 'Sport', 'url' => array('/article/sport/'), 'active' => $controller_name == 'sport'),
                                                    array('label' => 'Movie', 'url' => array('/article/movie/'), 'active' => $controller_name == 'movie'),
                                                    array('label' => 'Mv Music', 'url' => array('/article/mv/'), 'active' => $controller_name == 'mv'),
                                                    array('label' => 'Travel', 'url' => array('/article/travel/'), 'active' => $controller_name == 'travel'),
                                                    array('label' => 'หอพัก / ร้านอาหาร / ร้านค้า', 'url' => array('/article/miscellaneous/'), 'active' => $controller_name == 'miscellaneous'),
                                                    array('label' => 'MorBuu Boy & Girl', 'url' => array('/article/boygirl/'), 'active' => $controller_name == 'boygirl'),
                                                    array('label' => 'VIDEO CLIP', 'url' => array('/article/vido/'), 'active' => $controller_name == 'vido'),
                                            ),
